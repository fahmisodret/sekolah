                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="post" action="{{ url('/admin/frontgenerator') }}">
                            ...
                            <div class="form-group row">
                                <label for="route_group" class="col-md-6 col-form-label text-right">Route Group Prefix : <span class="text-danger"></span></label>
                                <div class="col-md-4">
                                    <input type="text" name="route_group" class="form-control" id="route_group" placeholder="front" value="front">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="view_path" class="col-md-4 col-form-label text-right">View Path:</label>
                                <div class="col-md-6">
                                    <input type="text" name="view_path" class="form-control" id="view_path" placeholder="front/pages" value="front/pages/">
                                </div>
                            </div>
                            <div class="form-group row">
